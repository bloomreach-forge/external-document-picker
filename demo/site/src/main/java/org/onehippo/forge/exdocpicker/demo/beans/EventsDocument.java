package org.onehippo.forge.exdocpicker.demo.beans;
/*
...
@HippoEssentialsGenerated(internalName = "exdocpickerbasedemo:eventsdocument")
@Node(jcrType="exdocpickerbasedemo:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public final static String DOCUMENT_TYPE = "exdocpickerbasedemo:eventsdocument";

    private final static String TITLE = "exdocpickerbasedemo:title";
    private final static String DATE = "exdocpickerbasedemo:date";
    private final static String INTRODUCTION = "exdocpickerbasedemo:introduction";
    private final static String IMAGE = "exdocpickerbasedemo:image";
    private final static String CONTENT = "exdocpickerbasedemo:content";
    private final static String LOCATION = "exdocpickerbasedemo:location";
    private final static String END_DATE = "exdocpickerbasedemo:enddate";
