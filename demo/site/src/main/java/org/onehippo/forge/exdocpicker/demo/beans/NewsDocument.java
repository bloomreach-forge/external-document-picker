...
public class NewsDocument extends HippoDocument {
     ...
     */
    public final static String DOCUMENT_TYPE = "exdocpickerbasedemo:newsdocument";
    ...
    private final static String AUTHOR = "exdocpickerbasedemo:author";
    private final static String SOURCE = "exdocpickerbasedemo:source";
