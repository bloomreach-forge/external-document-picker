...
Browsing the embedded HSQLDB database
=====================================

  Run the following in a command line console:

    $ java -jar target/tomcat7x/shared/lib/hsqldb-2.3.2.jar

  - Select 'HSQL Database Engine WebServer' in 'Type' field.
  - Keep 'org.hsqldb.jdbcDriver' in 'Driver' field.
  - Enter 'jdbc:hsqldb:http://localhost:8080/hsqldb/' in 'URL' field.
  - Enter 'SA' in 'User' field.
